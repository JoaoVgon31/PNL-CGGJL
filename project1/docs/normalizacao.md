...
A implementação está em `project1/src/normalizacao/` e usa regras, expressões regulares e dicionários. Modelos de linguagem não participam da extração dos dados, em conformidade com a restrição do projeto.
